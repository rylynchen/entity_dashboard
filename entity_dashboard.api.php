 ...
 */
function hook_entity_dashboard_regions() {
 ...
 *   hook_entity_dashboard_regions().
 */
function hook_entity_dashboard_regions_alter($regions) {
  // Remove the sidebar region defined by the core dashboard module.
  unset($regions['entity_dashboard_sidebar']);
}
